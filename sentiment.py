...
def cleantweets(tweet):
    ...
    # Repeating words like sorryyyyyyyy
    ...
    emoticons = \
        [
            ('__positive__', [':-)', ':)', '(:', '(-:', ':-D', ':D', 'X-D', 'XD', 'xD', '<3', ':\*', ';-)', ';)', ';-D',';D', '(;', '(-;', ]), ('__negative__', [':-(', ':(', '(:', '(-:', ':,(', ':\'(', ':"(', ':((', ])]
...
def predict(tweet, classifier):
    tweet_processed = stem(cleantweets(tweet))
...
def main():
    print('Loading Classifier, please wait....')
